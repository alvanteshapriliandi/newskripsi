...
class kopsuratController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['product']= $product = DB::select("select p.*, s.name, u.username from products p inner join subcategories s on p.subcategory_id = s.id inner join users u on p.freelancer_id = u.id where subcategory_id = 4");
        return view('user.kopsurat.kopsurat_list',$data);
    }
    ...
    public function show($id)
    {
        ...
        return view('user.kopsurat.kopsurat_create',$data);
    }
