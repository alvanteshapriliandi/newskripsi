...
class xbannerController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['product']= $product = DB::select("select p.*, s.name, u.username from products p inner join subcategories s on p.subcategory_id = s.id inner join users u on p.freelancer_id = u.id where subcategory_id = 14");
        return view('user.xbanner.xbanner_list',$data);
    }
    ...
    public function show($id)
    {
        ...
        return view('user.xbanner.xbanner_create',$data);
    }
