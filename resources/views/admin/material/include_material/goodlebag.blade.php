<div class="form-content">
	...
	<div class="row group">
		<div class="form-group{{ $errors->has('harga_awal') ? ' has-error' : '' }} col-md-4">
			<label class="col-xs-12" for="harga_awal">Model Cetak <span class="required">*</span>
			</label>
			<div class="col-xs-12">
		...
		<div class="form-group{{ $errors->has('harga_awal') ? ' has-error' : '' }} col-md-4">
			...
			<div class="col-xs-12">
				<input type="text" value="SPUNBOND 100 GR" id="harga_awal" name="harga_awal" class="form-control col-md-7 col-xs-12">
				@if ($errors->has('harga_awal'))
				<span class="help-block">{{ $errors->first('harga_awal') }}</span>
				@endif
			</div>
		...
		<div class="form-group{{ $errors->has('harga_awal') ? ' has-error' : '' }} col-md-3">
			<label class="col-xs-12" for="harga_awal">Sisi <span class="required">*</span>
			</label>
			<div class="col-xs-12">
				<select name="category" id="category" class="category form-control col-md-7 col-xs-12" data-token="{{ csrf_token()}}">
		...
		<div class="form-group{{ $errors->has('harga_awal') ? ' has-error' : '' }} col-md-3">
			<label class="col-xs-12" for="harga_awal">Jumlah pesanan <span class="required">*</span>
			</label>
			<div class="col-xs-12">
				<select name="category" id="category" class="category form-control col-md-7 col-xs-12" data-token="{{ csrf_token()}}">
