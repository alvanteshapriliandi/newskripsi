<div class="form-content">
	...
	<div class="row group">
		<div class="form-group{{ $errors->has('harga_awal') ? ' has-error' : '' }} col-md-2">
			<label class="col-xs-12" for="harga_awal">Model Bantal <span class="required">*</span>
			</label>
			<div class="col-xs-12">
		...
		<div class="form-group{{ $errors->has('harga_awal') ? ' has-error' : '' }} col-md-2">
			<label class="col-xs-12" for="harga_awal">Jenis Kain <span class="required">*</span>
			</label>
			<div class="col-xs-12">
				<select name="category" id="category" class="category form-control col-md-7 col-xs-12" data-token="{{ csrf_token()}}">
					<option value="0" disabled="true" selected="true">-Pilih Jenis Kain-</option>
					<option value="50">50</option>
					<option value="50">100</option>
					<option value="50">200</option>
					<option value="50">300</option>
