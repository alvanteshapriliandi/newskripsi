    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form method="post" action="{{ route('bank.update', ['id'=>$bank->id]) }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('atas_nama') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{$bank->atas_nama}}" id="bank" name="atas_nama" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('name_bank') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{$bank->name_bank}}" id="bank" name="name_bank" class="form-control col-md-7 col-xs-12">
                         ...
                         <div class="form-group{{ $errors->has('no_rekening') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{$bank->no_rekening}}" id="product" name="no_rekening" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('images_bank') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="file" value="{{$bank->images_bank}}" id="images_bank" name="images_bank" class="form-control col-md-7 col-xs-12">
